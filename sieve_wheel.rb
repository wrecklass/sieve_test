def eratosthenes2(n, j)
  # j is the number of primes we want to
  # discover and print the last (jth) prime
  #
  ...
  nums.each_index { |i|
    ...
    break if primes.size() >= j
  }
  primes.pop while primes.last > n
  puts "Total Primes  = #{primes.size()}"
  puts "Max Prime = #{primes.last}"
end

eratosthenes2(16000000, 1000000)
